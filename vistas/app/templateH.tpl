...
<head>
    ...
    <link rel="stylesheet" href="{views::asset('css/bootstrap.min.css')}">
    <link rel="stylesheet" href="{views::asset('css/font-awesome.min.css')}">
    <link rel="stylesheet" href="{views::asset('css/sidebar.css')}">
